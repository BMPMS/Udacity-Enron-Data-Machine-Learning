...
newfeaturelist = ['exercised_stock_options/salary','bonus/salary','retention_incentives/key_payments','no_dirdefrestock','odd_payments','key_payments','deferral_balance','retention_incentives','total_of_totals','poi_emails']
